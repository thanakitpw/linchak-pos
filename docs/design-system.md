...
| `mobile_9` / `tablet_10` | ใบเสร็จ + PromptPay QR | FR-4 | ✓ | ✅ `/receipt/[id]` (บิล public ยังไม่ทำ) |
...
- FR-4.6 หน้าบิล public (mockup มีปุ่ม "ดูบิลออนไลน์" แต่ไม่มีหน้าปลายทาง) — **ปุ่มคัดลอกลิงก์ในใบเสร็จชี้ไปแล้ว หน้ายัง 404**
